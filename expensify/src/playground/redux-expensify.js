...
// Use a single reducer for each root property on our Redux store.
...
// Time since January 1st 1970 (unix epoch in milliseconds)
...
// store.dispatch(editExpense({ id: expense2.expense.id }, { amount: 500, description: "San Fran Coffee" }))
